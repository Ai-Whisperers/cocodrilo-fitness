...
export const metadata = { title: "Contacto — Complejo Cocodrilo", description: "Visitanos o contactanos por WhatsApp." };
        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="rounded-xl overflow-hidden border border-gray-200 shadow-sm h-[300px]">
              <iframe src={"https://maps.google.com/maps?q="+encodeURIComponent("Av. Santísima Trinidad, Asunción")+"&output=embed"}
